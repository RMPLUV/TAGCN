...
def Data_load(num_timesteps_input, num_timesteps_output):
    ...
    # A, X, means, stds, X_val, Weather, Weather_val = load_metr_la_data()
    ...
    # train_weather = Weather[:split_line1]
    ...
    # return A, means, stds, training_input, training_target, val_input, val_target, test_input, test_target, train_weather, Weather_val
