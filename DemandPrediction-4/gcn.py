...
class STGCNBlock(nn.Module):
    ...
    def __init__(self, in_channels, spatial_channels, out_channels, num_nodes):
        ...
        self.Theta1 = nn.Parameter(torch.FloatTensor(spatial_channels,spatial_channels))      #改过1-->24
    ...
    def forward(self, X, A_hat):
        ...
        # t = self.temporal1(X)
        lfs = torch.einsum("ij,lkj->lki", [A_hat, X])#.permute(1, 0, 2, 3)
...
class STGCN(nn.Module):
    ...
    def __init__(self, num_nodes, num_features, num_timesteps_input,
        ...
        self.block1 = STGCNBlock(in_channels=num_features, out_channels=64,
                                 spatial_channels=60, num_nodes=num_nodes)
        ...
        # self.con=nn.Conv2d(in_channels=24,
        #                    out_channels=24,
        #                    kernel_size=(3,10))
        #
